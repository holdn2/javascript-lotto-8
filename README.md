...
- 로또 구입 금액을 입력 받아 숫자로 반환한다.
  - 숫자 외의 문자를 포함할 경우 예외를 발생시킨다.
  - `1,000`으로 나누어 떨어지지 않을 경우 예외를 발생시킨다.
...
- 당첨 번호를 입력받고 쉼표(`,`)를 기준으로 파싱하여 숫자 배열로 반환한다.
  - 숫자와 쉼표(`,`) 외의 문자를 포함할 경우 에러를 발생시킨다.
- 보너스 번호를 입력 받아 숫자로 반환한다.
  - 숫자 외의 문자를 포함할 경우 에러를 발생시킨다.
...
- [ERROR] 로또 번호는 범위 내 숫자로만 입력 가능합니다. (범위: 1 ~ 45)
- [ERROR] 보너스 번호는 범위 내 숫자로만 입력 가능합니다. (범위: 1 ~ 45)
- [ERROR] 로또 번호는 6개여야 합니다.
- [ERROR] 로또 구입 금액과 보너스 번호는 숫자로만 입력 가능합니다.
